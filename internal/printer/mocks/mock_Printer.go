...
func (_m *MockPrinter) Print(ref interface{}, values []interface{}) error {
...
func (_c *MockPrinter_Print_Call) Run(run func(ref interface{}, values []interface{})) *MockPrinter_Print_Call {
...
func (_c *MockPrinter_Print_Call) RunAndReturn(run func(interface{}, []interface{}) error) *MockPrinter_Print_Call {
	_c.Call.Return(run)
	return _c
}
